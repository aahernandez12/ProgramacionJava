...
public class Principal {
	...
	public static void main(String[] args) {
		...
		//crear un nuevo objeto controlador con valor inicial 10
		Contador contador2 = new Contador(10);
		
		//incrementar y decrementar el contador2 y mostar su valor
		...
		//mostrar el valor del contador3
